    ...
    async function fetchData() {
      ...
      try {
        const [positionRes, patrimonyRes] = await Promise.all([
          api.get(`/portfolio/${selectedPortfolio?.id}/brl_stocks/position`),
        ...
        console.error('Erro ao buscar dados de Ações BR', err)
        setError('Erro ao carregar dados de Ações BR.')
      } finally {
        setIsLoading(false)
      }
    }
